...
getPdf(Resume resume) async {
          ...
          children: [
            ...
            Row(
              children: <Widget>[
                Container(
                  alignment: Alignment.centerLeft,
                  child: Text(experience.designation,
  ...
  getExperience(Context context) =>
      Column(children: _buildExperienceList(context));
        ...
        UrlLink(
            child: Container(
              ...
              child: Text(
                ...
                style:
                    Theme.of(context).header5.copyWith(color: PdfColors.blue),
              ),
            ),
  ...
  List<Widget> _buildEducationList(context) {
  ...
  getEducation(Context context) =>
      Column(children: _buildEducationList(context));
  ...
  _getProfileImage(Context context) {
    return Positioned(
      ...
      child: Container(
        ...
        child: Image(image
            as ImageProvider), // Use the PdfImage directly in the Image widget
      ),
    );
  }

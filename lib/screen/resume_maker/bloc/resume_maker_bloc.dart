...
import 'package:resume_app/utility/constants.dart';
import 'package:resume_app/utility/create_pdf.dart';
...
class ResumeMakerBloc {
  ...
  Stream<File> get pictureClickStream =>
      _pictureClickBehaviorSubject.stream.asBroadcastStream();
  ...
  Stream<Education> get educationListModifiedStream =>
      _educationListModifiedBehaviorSubject.stream.asBroadcastStream();

  Sink<Education> get educationListModifiedSink =>
      _educationListModifiedBehaviorSubject.sink;
  ...
  Sink<Experience> get experienceListModifiedSink =>
      _experienceListModifiedBehaviorSubject.sink;

  final _projectListModifiedBehaviorSubject = PublishSubject<Project>();

  Stream<Project> get projectListModifiedStream =>
      _projectListModifiedBehaviorSubject.stream.asBroadcastStream();

  Sink<Project> get projectListModifiedSink =>
      _projectListModifiedBehaviorSubject.sink;

  final _skillListModifiedBehaviorSubject = PublishSubject<String>();

  Stream<String> get skillListModifiedStream =>
      _skillListModifiedBehaviorSubject.stream.asBroadcastStream();

  Sink<String> get skillListModifiedSink =>
      _skillListModifiedBehaviorSubject.sink;

  final _referenceListModifiedBehaviorSubject = PublishSubject<Reference>();

  Stream<Reference> get referenceListModifiedStream =>
      _referenceListModifiedBehaviorSubject.stream.asBroadcastStream();

  Sink<Reference> get referenceListModifiedSink =>
      _referenceListModifiedBehaviorSubject.sink;

  final _languageListModifiedBehaviorSubject = PublishSubject<Language>();

  Stream<Language> get languageListModifiedStream =>
      _languageListModifiedBehaviorSubject.stream.asBroadcastStream();

  Sink<Language> get languageListModifiedSink =>
      _languageListModifiedBehaviorSubject.sink;
  ...
  Stream<bool> get saveProfileButtonEnableStream =>
      _saveProfileButtonEnableBehaviorSubject.stream.asBroadcastStream();

  Sink<bool> get saveProfileButtonEnableSink =>
      _saveProfileButtonEnableBehaviorSubject.sink;
  ...
  Sink<bool> get saveProfileSummaryButtonEnableSink =>
      _saveProfileSummaryButtonEnableBehaviorSubject.sink;

  final _saveContactButtonEnableBehaviorSubject = PublishSubject<bool>();

  Stream<bool> get saveContactButtonEnableStream =>
      _saveContactButtonEnableBehaviorSubject.stream.asBroadcastStream();

  Sink<bool> get saveContactButtonEnableSink =>
      _saveContactButtonEnableBehaviorSubject.sink;

  final _skillIconBehaviorSubject = PublishSubject<bool>();

  Stream<bool> get skillIconStream =>
      _skillIconBehaviorSubject.stream.asBroadcastStream();
  ...
  Stream<bool> get previewButtonVisibilityStream =>
      _previewButtonVisibilityBehaviorSubject.stream.asBroadcastStream();

  Sink<bool> get previewButtonVisibilitySink =>
      _previewButtonVisibilityBehaviorSubject.sink;
      ...
      case NAVIGATE_TO_PROFILE_TAB:
        {
          ...
          profileSummary != null && profileSummary.isNotEmpty

...
class _ProfileSummaryTabState extends State<ProfileSummaryTab> {
  ...
  void didChangeDependencies() {
    ...
    _summaryController.text =
        _bloc.profileSummary != null ? _bloc.profileSummary : '';
    _summaryController..addListener(_onSummaryChange);
  }

  void _onSummaryChange() {
    final _bloc = ResumeMakerBlocProvider.of(context);
    if (_bloc.profileSummary != null &&
        _summaryController.text != _bloc.profileSummary) {
              ...
              StreamBuilder<bool?>(
                ...
                builder: (context, snapshot) {
                  bool isEnable = snapshot.data ??
                      (_bloc.profileSummary != null ? false : true);

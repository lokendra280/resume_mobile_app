...
import 'package:resume_app/screen/resume_maker/widget/onboarding_header_text.dart';
import 'package:resume_app/widget/country_code_picker.dart';
...
class _ContactTabState extends State<ContactTab> {
  ...
  void didChangeDependencies() {
    ...
    _emailController.text =
        _bloc.contact != null ? _bloc.contact.email : _emailController.text;
    _emailController..addListener(_onEmailChange);

    _phoneController.text =
        _bloc.contact != null ? _bloc.contact.phone : _phoneController.text;
    _phoneController..addListener(_onPhoneChange);

    _linkedController.text =
        _bloc.contact != null ? _bloc.contact.linkedin : _linkedController.text;
    _linkedController..addListener(_onLinkedInChange);

    _codeController.text = _bloc.contact != null
        ? _bloc.contact.countryCode
  ...
  void _onLinkedInChange() {
    final _bloc = ResumeMakerBlocProvider.of(context);
    if (_bloc.contact != null &&
        _linkedController.text != _bloc.contact.linkedin) {
      _bloc.enableSaveContactButton(true);
    }
  }
  ...
  void _onCodeChnage() {
    final _bloc = ResumeMakerBlocProvider.of(context);
    if (_bloc.contact != null &&
        _codeController.text != _bloc.contact.countryCode) {
      _bloc.enableSaveContactButton(true);
    }
  }
            ...
            children: <Widget>[
              ...
              StreamBuilder<bool?>(
                ...
                builder: (context, snapshot) {
                  bool isEnable =
                      snapshot.data ?? (_bloc.contact != null ? false : true);

...
class _ProfileTabState extends State<ProfileTab> {
  ...
  void didChangeDependencies() {
    ...
    _cityController.text =
        _bloc.profile != null ? _bloc.profile.currentCityAndCountry : '';
  ...
  void _onDesignationChange() {
    final _bloc = ResumeMakerBlocProvider.of(context);
    if (_bloc.profile != null &&
        _designationController.text != _bloc.profile.designation) {
      _bloc.saveProfileButtonEnableSink.add(true);
      _bloc.nextButtonEnableSink.add(false);
    }
  }
  ...
  void _onCityChange() {
    final _bloc = ResumeMakerBlocProvider.of(context);
    if (_bloc.profile != null &&
        _cityController.text != _bloc.profile.currentCityAndCountry) {
      _bloc.saveProfileButtonEnableSink.add(true);
      _bloc.nextButtonEnableSink.add(false);
    }
  }
              ...
              StreamBuilder<bool>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    bool isEnable = snapshot.data ??
                        (_bloc.saveContactButtonEnableStream != null
                            ? false
                            : true);

...
import 'package:resume_app/screen/resume_maker/bloc/resume_maker_bloc.dart';
...
class UserPictureWidget extends StatelessWidget {
          ...
          return Transform.scale(
            ...
            child: Transform.translate(
              ...
              child: Stack(
                alignment: Alignment.center,
                children: <Widget>[
                  _buildContainer(MediaQuery.of(context).size.shortestSide *
                      0.46 *
                      controller.value),
                  _buildContainer(MediaQuery.of(context).size.shortestSide *
                      0.52 *
                  ...
                  Container(
                    ...
                    child: InkWell(
                      onTap: _bloc.currentPage == NAVIGATE_TO_PROFILE_TAB
                          ? () => getImage(_bloc)
                          : null,
                      child: Card(
  ...
  Future getImage(ResumeMakerBloc _bloc) async {
    try {
      ...
      // Update the UI or perform actions with the cropped image

...
class _AddEducationDialogState extends State<AddEducationDialog> {
  ...
  void initState() {
    ...
    _universityController = TextEditingController(
        text: widget.education != null ? widget.education.universityName : '');
    _courseController = TextEditingController(
        text: widget.education != null ? widget.education.courseTaken : '');
    _linkController = TextEditingController(
        text: widget.education != null ? widget.education.collegeLink : '');

    _bloc.startDate =
        widget.education != null ? widget.education.startDate : DateTime.now();
    _bloc.endDate =
        widget.education != null ? widget.education.endDate : DateTime.now();
  }
